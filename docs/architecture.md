...
- Image uploads require a signed-in same-origin request, accept supported image types up to 4MB, and use server-derived dimensions and byte counts rather than client metadata.
